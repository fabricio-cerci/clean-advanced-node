import { ConnectionNotFoundedError, PgConnection } from '@/infra/repos/postgres/helpers'
...
describe('PgConnection', () => {
  ...
  it('should return ConnectionNotFoundedError on closeTransaction if connection is not found', async () => {
  ...
  it('should return ConnectionNotFoundedError on commit if connection is not found', async () => {
